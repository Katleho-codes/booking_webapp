...
function ServiceOrderDTVHA() {
    const router = useRouter();
    const { id } = router.query;
    const { getAllTicketsDTV, getAllTicketsError } = useFetchTickets()
    ...
    return (
        <>
            <Head>
                <title>DTV/HA Tickets | MMALLONTHEMOVE</title>
            </Head>
            <Sidebar />
            <Container>  <h1 className="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl text-center">DTV/HA Tickets</h1>
...
export default ServiceOrderDTVHA
